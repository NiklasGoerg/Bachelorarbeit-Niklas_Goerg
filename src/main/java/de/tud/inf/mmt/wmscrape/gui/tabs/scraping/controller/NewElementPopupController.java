...
import de.tud.inf.mmt.wmscrape.gui.tabs.scraping.data.ContentType;
import de.tud.inf.mmt.wmscrape.gui.tabs.scraping.data.MultiplicityType;
...
public class NewElementPopupController {
    ...
    private void initialize() {
        ...
        contentTypeChoiceBox.setValue(ContentType.AKTIEN);
